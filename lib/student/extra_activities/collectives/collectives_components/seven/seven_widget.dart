...
import 'seven_model.dart';
export 'seven_model.dart';

class SevenWidget extends StatefulWidget {
  const SevenWidget({super.key});

  @override
  State<SevenWidget> createState() => _SevenWidgetState();
}

class _SevenWidgetState extends State<SevenWidget> {
  late SevenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SevenModel());
