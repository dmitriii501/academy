      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              'Студенческое научное общество - это люди, которые развивают науку среди студентов Уральского института управления РАНХиГС😍\n\nДумаешь наука - это сложно? Мы докажем обратное!',
          ...
          Padding(
            ...
            child: InkWell(
              ...
              onTap: () async {
                await launchURL('https://vk.com/sno_uiu');
              },
              child: Text(
                'Перейти в группу ВК👈',
                style: FlutterFlowTheme.of(context).bodyMedium.override(
