...
import '/student/study/my_works/comp7/comp7_widget.dart';
import '/index.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'my_works_model.dart';
export 'my_works_model.dart';
...
class MyWorksWidget extends StatefulWidget {
  ...
  static String routeName = 'my_works';
  static String routePath = '/myWorks';
...
class _MyWorksWidgetState extends State<MyWorksWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyWorksModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<UsersRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRow> myWorksUsersRowList = snapshot.data!;

        final myWorksUsersRow =
            myWorksUsersRowList.isNotEmpty ? myWorksUsersRowList.first : null;
              ...
              children: [
                FutureBuilder<List<StudentsRow>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<StudentsRow> containerStudentsRowList = snapshot.data!;
                                                                        ...
                                                                        FutureBuilder<
                                                                          ...
                                                                          future:
                                                                            ...
                                                                            queryFn: (q) =>
                                                                                q.eqOrNull(
                                                                              'topic_id',
                                                                              listViewAssignmentsRow.topicId,
                                                                            ),
                                                                          ),
                                                                          builder:
                                                                              (context, snapshot) {
                                                                            ...
                                                                            List<SubjectTopicsRow>
                                                                                nameSubjectTopicsRowList =
                                                                                snapshot.data!;

                                                                            final nameSubjectTopicsRow = nameSubjectTopicsRowList.isNotEmpty
                                                                                ? nameSubjectTopicsRowList.first
                                                                                : null;

                                                                            return Text(
                                                                              valueOrDefault<String>(
                                                                                nameSubjectTopicsRow?.topic,
                                                                                'topic',
                                                                              ).maybeHandleOverflow(
                                                                                maxChars: 25,
                                                                                replacement: '…',
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        Text(
                                                                          valueOrDefault<
                                                                              String>(
                                                                            listViewAssignmentsRow.typeOfWork,
                                                                            'type',
                                                                          ),
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodyMedium
