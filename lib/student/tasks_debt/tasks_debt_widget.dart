...
import 'tasks_debt_model.dart';
export 'tasks_debt_model.dart';

class TasksDebtWidget extends StatefulWidget {
  const TasksDebtWidget({
    super.key,
    required this.nav,
  });
  ...
  static String routeName = 'tasksDebt';
  static String routePath = '/tasksDebt';

  @override
  State<TasksDebtWidget> createState() => _TasksDebtWidgetState();
}

class _TasksDebtWidgetState extends State<TasksDebtWidget> {
  late TasksDebtModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TasksDebtModel());
