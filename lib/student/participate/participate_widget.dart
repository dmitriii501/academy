...
import '/example_components/event3/event3_widget.dart';
...
import 'participate_model.dart';
export 'participate_model.dart';

class ParticipateWidget extends StatefulWidget {
  const ParticipateWidget({super.key});

  static String routeName = 'participate';
  static String routePath = '/participate';

  @override
  State<ParticipateWidget> createState() => _ParticipateWidgetState();
}

class _ParticipateWidgetState extends State<ParticipateWidget> {
  late ParticipateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ParticipateModel());
                                  ...
                                  Opacity(
                                    ...
                                    child: Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Text(
                                          valueOrDefault<String>(
                                            columnEventsRow.eventDescription,
                                            'desc',
                                          ).maybeHandleOverflow(
                                            maxChars: 30,
                                            replacement: '…',
