...
import '/teacher/cp_copy1/cp_copy1_widget.dart';
...
class _AttendanceWidgetState extends State<AttendanceWidget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<GroupStatementRow>>(
      future: GroupStatementTable().queryRows(
        queryFn: (q) => q
            .eqOrNull(
              'subject_id',
              widget.subj?.subjectId,
            )
            .eqOrNull(
              'groupid',
      ...
      builder: (context, snapshot) {
        ...
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            body: SafeArea(
              top: true,
              child: FutureBuilder<List<CheckDisableRow>>(
                future: Future.value(const <CheckDisableRow>[]),
                builder: (context, snapshot) {
                  // Customize what your widget looks like when it's loading.
                  if (!snapshot.hasData) {
                    return Center(
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: FutureBuilder<
                                                ...
                                                future: StudentPerformanceTable()
                                                    .queryRows(
                                                  queryFn: (q) => q
                                                      .eqOrNull(
                                                        'group_id',
                                                                          ...
                                                                          Container(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              builder: (context) => InkWell(
                                                                                    ...
                                                                                    builder: (dialogContext) {
                                                                                      return Dialog(
                                                                                        ...
                                                                                        child: GestureDetector(
                                                                                          ...
                                                                                          child: CpCopy1Widget(
                                                                                            stuentpriority: listViewStudentPerformanceRow,
                                                                                            date: _model.date ?? widget.date,
                                                                                          ),
                                                                                        ),
                                                                                      );
                                                                                    },
                                                                                ...
                                                                                child: Stack(
                                                                                  children: [
                                                                                    if (listViewStudentPerformanceRow.isAttended != true)
                                                                                      Align(
                                                                                        alignment: AlignmentDirectional(0.0, 0.0),
                                                                                        child: Text(
                                                                                          () {
                                                                                            if (listViewStudentPerformanceRow.reasonOfPass == 'УП') {
                                                                                              return 'УП';
                                                                                            } else if (listViewStudentPerformanceRow.reasonOfPass == 'Б') {
                                                                                              return 'Б';
                                                                                            } else if (listViewStudentPerformanceRow.reasonOfPass == 'О') {
                                                                                              return 'О';
                                                                                            } else if (listViewStudentPerformanceRow.reasonOfPass == 'НП') {
                                                                                              return 'НП';
                                                                                            } else {
                                                                                              return '0';
                                                                                            }
