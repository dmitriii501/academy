...
import 'group_statement_model.dart';
export 'group_statement_model.dart';

class GroupStatementWidget extends StatefulWidget {
  const GroupStatementWidget({
    super.key,
  ...
  static String routeName = 'groupStatement';
  static String routePath = '/groupStatement';

  @override
  State<GroupStatementWidget> createState() => _GroupStatementWidgetState();
}

class _GroupStatementWidgetState extends State<GroupStatementWidget> {
  late GroupStatementModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GroupStatementModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.date = getCurrentTimestamp;
      safeSetState(() {});
      _model.fghkj = await CheckDisableTable().queryRows(
        queryFn: (q) => q.eqOrNull(
          'id',
          1,
        ),
      );
      _model.bool1 = _model.fghkj!.firstOrNull!.check;
      safeSetState(() {});
      _model.onPage = widget.onPage;
      safeSetState(() {});
      _model.groupStatement = await GroupStatementTable().queryRows(
        queryFn: (q) => q
            .eqOrNull(
              'subject_id',
              ...
              SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(9.0, 10.0, 9.0, 0.0),
                      child: Container(
                        width: 100.0,
                        height: 100.0,
                    ...
                    Column(
                      ...
                      children: [
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              9.0, 25.0, 9.0, 0.0),
                          child: FutureBuilder<List<StudentPerformanceRow>>(
                            future: StudentPerformanceTable().queryRows(
                              queryFn: (q) => q
                                  .eqOrNull(
                                    'date',
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<StudentPerformanceRow>
                                  containerStudentPerformanceRowList =
                                  snapshot.data!;
                                ...
                                child: Builder(
                                  builder: (context) {
                                    ...
                                    return FlutterFlowDataTable<
                                      ...
                                      dataRowHeight: 50.0,
                                      columnSpacing: 3.0,
                                      headingRowColor: Color(0xFF9CFFF7),
