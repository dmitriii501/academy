...
class TestassignmentsTable extends SupabaseTable<TestassignmentsRow> {
  @override
  String get tableName => 'testassignments';

  @override
  TestassignmentsRow createRow(Map<String, dynamic> data) =>
      TestassignmentsRow(data);
}

class TestassignmentsRow extends SupabaseDataRow {
  TestassignmentsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => TestassignmentsTable();
